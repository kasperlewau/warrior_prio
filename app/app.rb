...
@reg_mods = {
  ...
  target_armor: Mod.new(multiplier: 0.6503),
...
@abilities = {
  ...
  tc:       ThunderClap.new(name: 'Thunder Clap', cost: 10.00, base: 1.40), # Tooltip assumes a 1.2 Base.
  tc_cs:    ThunderClap.new(name: 'Thunder Clap', cost: 10.00, base: 1.40, with: ['cs']), # Tooltip assumes a 1.2 Base.
  tc_g:     ThunderClap.new(name: 'Thunder Clap', cost: 10.00, base: 1.40, with: ['tc_glyph']), # Tooltip assumes a 1.2 Base.
  tc_g_cs:  ThunderClap.new(name: 'Thunder Clap', cost: 10.00, base: 1.40, with: ['cs', 'tc_glyph']), # Tooltip assumes a 1.2 Base.
  ex_10:    Execute.new(name: 'Execute', cost: 10.00, base: 1.50), # Tooltip assumes a 1.6 base.
  ex_40:    Execute.new(name: 'Execute', cost: 40.00, base: 1.50), # Tooltip assumes a 1.6 base.
  ex_10_cs: Execute.new(name: 'Execute', cost: 10.00, base: 1.50, with: ['cs']), # Tooltip assumes a 1.6 base.
  ex_40_cs: Execute.new(name: 'Execute', cost: 40.00, base: 1.50, with: ['cs']) # Tooltip assumes a 1.6 base.
}
